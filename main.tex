...
\begin{frame}
	...
	\end{align}
	où $\vect{u}^*$ est la prédiction de la vitesse, $\mu^n$ la viscosité discrète, $\rho^n_f$ la masse volumique discrète aux faces  et où $\vect{g}$ est le vecteur gravité.  %(obtenue par interpolation linéaire)
